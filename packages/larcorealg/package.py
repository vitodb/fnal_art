...
class Larcorealg(CMakePackage):
    ...
    url      = "ssh://p-larsoft@cdcvs.fnal.gov/cvs/projects/larcorealg"

    version('MVP1a', git='ssh://p-larsoft@cdcvs.fnal.gov/cvs/projects/larcorealg', branch='feature/Spack-MVP1a', preferred=True)
